...
abstract final class AppTheme {
  ...
  static ThemeData dark() => _build(
    ...
    scheme: const ColorScheme(
      ...
      onSecondaryContainer: AppColors.secondaryTextDark,
      tertiary: AppColors.softGreen,
      onTertiary: AppColors.midnight,
      tertiaryContainer: Color(0xFF1F4D3A),
      onTertiaryContainer: AppColors.softGreen,
      error: AppColors.error,
      ...
      inverseSurface: AppColors.warmCream,
    ...
    return ThemeData(
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          minimumSize: const Size.fromHeight(52),
          foregroundColor: isDark ? scheme.onSurface : scheme.secondary,
          side: BorderSide(
