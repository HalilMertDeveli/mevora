...
/// Merges music compatibility l10n into ARB files using strict UTF-8.
void main() {
  _merge(
    arbPath: r'D:\Mevora\lib\l10n\app_en.arb',
    jsonPath: r'D:\Mevora\tool\music_l10n_en.json',
  );
  _merge(
    arbPath: r'D:\Mevora\lib\l10n\app_tr.arb',
    jsonPath: r'D:\Mevora\tool\music_l10n_tr.json',
  );
  print('Merged music keys into ARB files (UTF-8).');
}
